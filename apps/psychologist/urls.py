...
from .views import HomePage, PsychologistListView, BlogListView, ViewFormFunction, CreateViewFunction, FinishViewForm, BlogDetailView


urlpatterns = [
    path('', HomePage.as_view(), name='homepage'),
    path('psychologits/', PsychologistListView.as_view(), name='list_psycholog'),
    path('psychologits/<str:slug>', PsychologistListView.as_view(), name='psychologist_detail'),
